...
Partial Class Admin_Reports_AttendanceReport
    ...
    Protected Sub btnShowData_Click(sender As Object, e As EventArgs) Handles btnShowData.Click
        ...
        Dim dt As Data.DataTable = dm.getdata("Select * from Attendance where Enrollment_id=" & DropDownList1.SelectedValue)
        ...
        For Each dr As Data.DataRow In dt.Rows
            ...
            str.Append("<td>")
            str.Append(CDate(dr.Item(2)).ToString("dd-MM-yy"))
            str.Append("</td>")
            ...
            str.Append("<td>")
            str.Append(dm.getValue("Select Status_name from Status where Status_id=" & dr.Item(3)))
            str.Append("</td>")
